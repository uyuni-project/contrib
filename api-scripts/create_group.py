#!/usr/bin/env python3
"""
SUSE Manager / Uyuni API - Create System Group
"""
...
def main():
    ...
    p.add_argument('-p', '--password'); p.add_argument('--name', required=True); p.add_argument('--desc', default="")
    ...
    try:
        ...
        c.systemgroup.create(k, args.name, args.desc)
