#!/usr/bin/env python3
"""
SUSE Manager / Uyuni API - Add System to Group
"""
...
def main():
    ...
    p.add_argument('--group', required=True); p.add_argument('--verify', action='store_true')
    args = p.parse_args()
    ...
    try:
        ...
        c.systemgroup.addOrRemoveSystems(k, args.group, [args.sid], True)
        print(f"[+] System {args.sid} added to group '{args.group}'.")
        c.auth.logout(k)
